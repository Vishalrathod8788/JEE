...
public class fetchstaff extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			pw.println("<tr><th>NAME</th><th>DOB</th><th>AGE</th><th>GENDER</th><th>ADDRESS</th><th>DEPARTMENT</th><th>POST</th><th>QUALIFICATION</th><th>EXPEREINCE</th><th>CONTACT NO.</th><th>ACTION<th></th><tr>");
			while(rs.next())
			{
				pw.println("<tr>");
				...
				pw.println("<td><a href='/SPORTSACADEMY/getstaff?id="+ rs.getString(1) +"'>update</a>||<a href='/SPORTSACADEMY/delstaff?id="+rs.getInt(1)+"'>delete</a></td> ");	
			...
			pw.println("<p><a href='frmstaff.html'>ADD RECORDS</a></p>");
			pw.println("</div>");
		}
