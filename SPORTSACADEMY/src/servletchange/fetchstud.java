...
@WebServlet("/fetchstud")
public class fetchstud extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			pw.println("<tr><th>NAME</th><th>DOB</th><th>AGE</th><th>GENDER</th><th>ADDRESS</th><th>GAME-NAME</th><th>CONTACT NO</th><th>BATCH TIME</th><th>ACTION</th><tr>");
			while(rs.next())
			{
				pw.println("<tr>");
				...
				pw.println("<td><a href='/SPORTSACADEMY/getstud?id="+ rs.getString(1) +"'>update</a>||<a href='/SPORTSACADEMY/delstud?id="+rs.getInt(1)+"'>delete</a></td> ");	
			...
			pw.println("<p><a href='frmstud.html'>ADD RECORD</a></p>");
			 pw.println("</div>");
		}
