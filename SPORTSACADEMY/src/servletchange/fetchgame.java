...
@WebServlet("/fetchgame")
public class fetchgame extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			pw.println("<tr><th>GAME-NAME</th><th>GAME-TYPE</th>");
			while(rs.next())
			{
				pw.println("<tr>");
				pw.println("<td>" + rs.getString(1) + "</td>");
				pw.println("<td>" + rs.getString(2) + "</td>");
				//pw.println("<td><a href='/priminsert/getrec?id="+ rs.getString(1) +"'>update</a>||<a href='/project/delgame?id="+rs.getString(1)+"'>delete</a></td> ");	
			...
			pw.println("<p><a href='frmgame.html'>ADD RECORD</a></p>");
			pw.println("</div>");
		}
