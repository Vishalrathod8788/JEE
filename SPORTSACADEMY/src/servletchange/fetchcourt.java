...
public class fetchcourt extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			pw.println("<tr><th>GAME-NAME</th><th>NO.OF COURT/GROUND</th><th>DIMENSION</th><th>ACTION</th><tr>");
			while(rs.next())
			{
				pw.println("<tr>");
				...
				pw.println("<td><a href='/SPORTSACADEMY/getcourt?id="+ rs.getString(1) +"'>update</a>");
			 ...
			 pw.println("<div class='links-container'>");
			   ...
			   // pw.println("<p><a href='frmcourt.html'>ADD RECORDS</a></p>");
			    pw.println("</div>");
