...
@WebServlet("/fetchexercise")
public class fetchexercise extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			pw.println("<tr><th>GAME-NAME</th><th>EXERCISE-NAME</th><th>SETS</th><th>REPS</th><th>ACTION</th><tr>");
			while(rs.next())
			{
				pw.println("<tr>");
				...
				pw.println("<td><a href='/SPORTSACADEMY/getex?id="+ rs.getString(1) +"'>update</a>||<a href='/SPORTSACADEMY/delexer?id="+rs.getInt(1)+"'>delete</a></td> ");	
		    ...
		    pw.println("<p><a href='frmex.html'>ADD RECORDS</a></p>");
		    pw.println("</div>");
