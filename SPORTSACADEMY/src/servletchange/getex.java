...
public class getex extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			qry="select * from exercise where eno="+id+"";
			...
			pw.println("<form action='upex' method='post'>"); 
			...
			pw.println(" <label>Exercise Name:</label>");				     
			pw.println("<input type='text' name='en' value='"+rs.getString(3)+"' required>");				      
							
			pw.println("<label>Total Set:</label>");				      
			pw.println("<input type='text' name='se' value='"+rs.getInt(4)+"' required>");				      
							
			pw.println("<label>Total reps:</label>");		          	  
			pw.println("<input type='text' name='re' value='"+rs.getInt(5)+"' required>");				      
