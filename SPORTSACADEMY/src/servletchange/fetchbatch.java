...
public class fetchbatch extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			pw.println("<tr><th>BATCH-NAME</th><th>TIME</th><th>ACTION</th><tr>");
			while(rs.next())
			{
				pw.println("<tr>");
				...
				pw.println("<td><a href='/SPORTSACADEMY/getbatch?id="+ rs.getString(1) +"'>update</a>||<a href='/SPORTSACADEMY/delbatch?id="+rs.getInt(1)+"'>delete</a></td> ");	
		    ...
		    pw.println("<p><a href='frmbatch.html'>ADD RECORDS</a></p>");
		    pw.println("</div>");
		}
